...
- Where no determination is made, the share of visitors resident abroad
  ...
  remains undefined; where it is made in 2028, the share rises to **86%**. These
  figures come from the multi-year projection, which is computed separately from
  the single-run results shown in the interface.
